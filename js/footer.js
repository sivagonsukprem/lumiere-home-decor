  ...
  <div class="container">
    <div class="footer-grid">
      <div class="footer-about">
        <div class="footer-logo">LUMIÈRE<span>.</span></div>
      ...
      <div class="footer-col">
        ...
        <ul class="footer-contact">
          ...
          <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6"><path stroke-linecap="round" stroke-linejoin="round" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg><span>hello@lumierehome.co.th</span></li>
    ...
    <div class="footer-bottom">
      <div>© 2026 LUMIÈRE HOME. สงวนลิขสิทธิ์ทุกประการ · Concept Demo</div>
