  ...
  <div class="container">
    <div class="footer-grid">
      ...
      <div class="footer-col">
        <h4>${t('footer_shopping')}</h4>
        <ul>
          <li><a href="${base}pages/shop/category.html">${t('nav_categories')}</a></li>
          <li><a href="${base}pages/shop/product-list.html">${t('nav_all_products')}</a></li>
          <li><a href="${base}pages/shop/product-list.html?filter=new">${t('nav_new')}</a></li>
          <li><a href="${base}pages/shop/product-list.html?filter=sale">${t('nav_sale')}</a></li>
          <li><a href="${base}pages/shop/cart.html">${t('nav_cart')}</a></li>
        </ul>
      </div>
      <div class="footer-col">
        <h4>${t('footer_account_col')}</h4>
        <ul>
          <li><a href="${base}pages/account/login.html">${t('footer_login')}</a></li>
          <li><a href="${base}pages/account/register.html">${t('footer_register')}</a></li>
          <li><a href="${base}pages/account/profile.html">${t('footer_profile')}</a></li>
          <li><a href="${base}pages/account/orders.html">${t('footer_orders')}</a></li>
          <li><a href="${base}pages/account/wishlist.html">${t('footer_wishlist')}</a></li>
        </ul>
      </div>
      <div class="footer-col">
        <h4>${t('footer_service')}</h4>
        <ul>
          <li><a href="${base}pages/contact.html">${t('nav_contact')}</a></li>
          <li><a href="${base}pages/faq.html">${t('footer_faq')}</a></li>
          <li><a href="${base}pages/shipping-policy.html">${t('footer_shipping_policy')}</a></li>
          <li><a href="${base}pages/return-policy.html">${t('footer_return_policy')}</a></li>
        </ul>
      </div>
      <div class="footer-col">
        ...
        <ul class="footer-contact">
          ...
          <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6"><path stroke-linecap="round" stroke-linejoin="round" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg><span>${t('footer_hours')}</span></li>
        </ul>
      </div>
    </div>
    <div class="footer-bottom">
      <div>© 2026 Bax Baxter Home Decor. ${t('footer_rights')}</div>
